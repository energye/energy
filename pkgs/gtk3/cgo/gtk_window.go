...
func wrapWindow(obj *Object) *Window {
	if obj == nil {
		return nil
	}

	return &Window{Bin{Container{Widget{InitiallyUnowned{obj}}}}}
}
...
func (v *Window) SetResizable(resizable bool) {
	C.gtk_window_set_resizable(v.native(), CBool(resizable))
}
...
func (v *Window) SetModal(modal bool) {
	C.gtk_window_set_modal(v.native(), CBool(modal))
}
...
func (v *Window) SetDestroyWithParent(setting bool) {
	C.gtk_window_set_destroy_with_parent(v.native(), CBool(setting))
}
...
func (v *Window) GetFocus() IWidget {
...
func (v *Window) GetDefaultWidget() IWidget {
...
func (v *Window) GetTransientFor() (*Window, error) {
	...
	return wrapWindow(ToGoObject(unsafe.Pointer(c))), nil
}

// GetAttachedTo is a wrapper around gtk_window_get_attached_to().
func (v *Window) GetAttachedTo() IWidget {
...
func WindowSetAutoStartupNotification(setting bool) {
	C.gtk_window_set_auto_startup_notification(CBool(setting))
}
...
func (v *Window) SetMnemonicsVisible(setting bool) {
	C.gtk_window_set_mnemonics_visible(v.native(), CBool(setting))
}
...
func (v *Window) SetFocusVisible(setting bool) {
	C.gtk_window_set_focus_visible(v.native(), CBool(setting))
}
...
func (v *Window) SetMnemonicModifier(mods ModifierType) {

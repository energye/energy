...
func NewRichEdit(AOnwer IComponent) IRichEdit {
	r1 := LCL().SysCallN(4165, GetObjectUintptr(AOnwer))
	return AsRichEdit(r1)
}

func (m *TRichEdit) Zoom() int32 {
	r1 := LCL().SysCallN(4172, 0, m.Instance(), 0)
	return int32(r1)
}

func (m *TRichEdit) SetZoom(AValue int32) {
	LCL().SysCallN(4172, 1, m.Instance(), uintptr(AValue))
}
...
func (m *TRichEdit) SetHideScrollBars(AValue bool) {
	LCL().SysCallN(4168, 1, m.Instance(), PascalBool(AValue))
}
...
func (m *TRichEdit) SetPlainText(AValue bool) {
	LCL().SysCallN(4170, 1, m.Instance(), PascalBool(AValue))
}
...
func (m *TRichEdit) SetDefAttributes(AValue ITextAttributes) {
	LCL().SysCallN(4166, 1, m.Instance(), GetObjectUintptr(AValue))
}

func (m *TRichEdit) SelAttributes() ITextAttributes {
	r1 := LCL().SysCallN(4171, 0, m.Instance(), 0)
	return AsTextAttributes(r1)
}

func (m *TRichEdit) SetSelAttributes(AValue ITextAttributes) {
	LCL().SysCallN(4171, 1, m.Instance(), GetObjectUintptr(AValue))
}
...
func (m *TRichEdit) SetParagraph(AValue IParaAttributes) {
	LCL().SysCallN(4169, 1, m.Instance(), GetObjectUintptr(AValue))
}

func (m *TRichEdit) FindText(ASearchStr string, AStartPos int32, ALength int32, AOptions TSearchTypes) int32 {
	r1 := LCL().SysCallN(4167, m.Instance(), PascalStr(ASearchStr), uintptr(AStartPos), uintptr(ALength), uintptr(AOptions))
	return int32(r1)
}

func RichEditClass() TClass {
	ret := LCL().SysCallN(4164)
	return TClass(ret)
}

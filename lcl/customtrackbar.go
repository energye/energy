...
func NewCustomTrackBar(AOwner IComponent) ICustomTrackBar {
	r1 := LCL().SysCallN(2166, GetObjectUintptr(AOwner))
	return AsCustomTrackBar(r1)
}

func (m *TCustomTrackBar) Frequency() int32 {
	r1 := LCL().SysCallN(2167, 0, m.Instance(), 0)
	return int32(r1)
}

func (m *TCustomTrackBar) SetFrequency(AValue int32) {
	LCL().SysCallN(2167, 1, m.Instance(), uintptr(AValue))
}
...
func (m *TCustomTrackBar) SetLineSize(AValue int32) {
	LCL().SysCallN(2168, 1, m.Instance(), uintptr(AValue))
}

func (m *TCustomTrackBar) Max() int32 {
	r1 := LCL().SysCallN(2169, 0, m.Instance(), 0)
	return int32(r1)
}

func (m *TCustomTrackBar) SetMax(AValue int32) {
	LCL().SysCallN(2169, 1, m.Instance(), uintptr(AValue))
}

func (m *TCustomTrackBar) Min() int32 {
	r1 := LCL().SysCallN(2170, 0, m.Instance(), 0)
	return int32(r1)
}

func (m *TCustomTrackBar) SetMin(AValue int32) {
	LCL().SysCallN(2170, 1, m.Instance(), uintptr(AValue))
}
...
func (m *TCustomTrackBar) SetReversed(AValue bool) {
	LCL().SysCallN(2174, 1, m.Instance(), PascalBool(AValue))
}
...
func (m *TCustomTrackBar) SetScalePos(AValue TTrackBarScalePos) {
	LCL().SysCallN(2175, 1, m.Instance(), uintptr(AValue))
}
...
func (m *TCustomTrackBar) SelStart() int32 {
	r1 := LCL().SysCallN(2177, 0, m.Instance(), 0)
	return int32(r1)
}

func (m *TCustomTrackBar) SetSelStart(AValue int32) {
	LCL().SysCallN(2177, 1, m.Instance(), uintptr(AValue))
}

func (m *TCustomTrackBar) ShowSelRange() bool {
	r1 := LCL().SysCallN(2181, 0, m.Instance(), 0)
	return GoBool(r1)
}

func (m *TCustomTrackBar) SetShowSelRange(AValue bool) {
	LCL().SysCallN(2181, 1, m.Instance(), PascalBool(AValue))
}

func (m *TCustomTrackBar) TickMarks() TTickMark {
	r1 := LCL().SysCallN(2182, 0, m.Instance(), 0)
	return TTickMark(r1)
}

func (m *TCustomTrackBar) SetTickMarks(AValue TTickMark) {
	LCL().SysCallN(2182, 1, m.Instance(), uintptr(AValue))
}
...
func CustomTrackBarClass() TClass {
	ret := LCL().SysCallN(2165)
	return TClass(ret)
}

func (m *TCustomTrackBar) SetTick(Value int32) {
	LCL().SysCallN(2180, m.Instance(), uintptr(Value))
}

func (m *TCustomTrackBar) SetParams(APosition, AMin, AMax int32) {
	LCL().SysCallN(2179, m.Instance(), uintptr(APosition), uintptr(AMin), uintptr(AMax))
}
...
func (m *TCustomTrackBar) SetOnChange(fn TNotifyEvent) {
	...
	LCL().SysCallN(2178, m.Instance(), m.changePtr)
}

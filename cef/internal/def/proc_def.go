...
func init() {
	var energyImportDefs = []*dllimports.ImportTable{
		...
		dllimports.NewEnergyImport("CEFChromium_LoadExtension", 0),
		dllimports.NewEnergyImport("CEFChromium_DidLoadExtension", 0),
		dllimports.NewEnergyImport("CEFChromium_HasExtension", 0),
		dllimports.NewEnergyImport("CEFChromium_GetExtensions", 0),
		dllimports.NewEnergyImport("CEFChromium_GetExtension", 0),
		...
		// ICefExtension
		dllimports.NewEnergyImport("CefExtensionRef_UnWrap", 0),
		...
		//dllimports.NewEnergyImport("ButtonDelegate_SetOnGetPreferredSize", 0),
		//dllimports.NewEnergyImport("ButtonDelegate_SetOnGetMinimumSize", 0),
		//dllimports.NewEnergyImport("ButtonDelegate_SetOnGetMaximumSize", 0),
		//dllimports.NewEnergyImport("ButtonDelegate_SetOnGetHeightForWidth", 0),
		//dllimports.NewEnergyImport("ButtonDelegate_SetOnParentViewChanged", 0),
		//dllimports.NewEnergyImport("ButtonDelegate_SetOnChildViewChanged", 0),
		//dllimports.NewEnergyImport("ButtonDelegate_SetOnWindowChanged", 0),
		//dllimports.NewEnergyImport("ButtonDelegate_SetOnLayoutChanged", 0),
		//dllimports.NewEnergyImport("ButtonDelegate_SetOnFocus", 0),
		//dllimports.NewEnergyImport("ButtonDelegate_SetOnBlur", 0),
		...
		//dllimports.NewEnergyImport("PanelDelegate_SetOnGetPreferredSize", 0),
		//dllimports.NewEnergyImport("PanelDelegate_SetOnGetMinimumSize", 0),
		//dllimports.NewEnergyImport("PanelDelegate_SetOnGetMaximumSize", 0),
		//dllimports.NewEnergyImport("PanelDelegate_SetOnGetHeightForWidth", 0),
		//dllimports.NewEnergyImport("PanelDelegate_SetOnParentViewChanged", 0),
		//dllimports.NewEnergyImport("PanelDelegate_SetOnChildViewChanged", 0),
		//dllimports.NewEnergyImport("PanelDelegate_SetOnWindowChanged", 0),
		//dllimports.NewEnergyImport("PanelDelegate_SetOnLayoutChanged", 0),
		//dllimports.NewEnergyImport("PanelDelegate_SetOnFocus", 0),
		//dllimports.NewEnergyImport("PanelDelegate_SetOnBlur", 0),
		// ICefWindowDelegate
		dllimports.NewEnergyImport("WindowDelegate_Create", 0),
		dllimports.NewEnergyImport("WindowDelegate_CreateForCustom", 0),
		//dllimports.NewEnergyImport("WindowDelegate_SetOnGetPreferredSize", 0),
		//dllimports.NewEnergyImport("WindowDelegate_SetOnGetMinimumSize", 0),
		//dllimports.NewEnergyImport("WindowDelegate_SetOnGetMaximumSize", 0),
		//dllimports.NewEnergyImport("WindowDelegate_SetOnGetHeightForWidth", 0),
		//dllimports.NewEnergyImport("WindowDelegate_SetOnParentViewChanged", 0),
		//dllimports.NewEnergyImport("WindowDelegate_SetOnChildViewChanged", 0),
		//dllimports.NewEnergyImport("WindowDelegate_SetOnWindowChanged", 0),
		//dllimports.NewEnergyImport("WindowDelegate_SetOnLayoutChanged", 0),
		//dllimports.NewEnergyImport("WindowDelegate_SetOnFocus", 0),
		//dllimports.NewEnergyImport("WindowDelegate_SetOnBlur", 0),

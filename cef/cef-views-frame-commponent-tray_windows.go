...
//}
//
//func newVFCefTray(owner lcl.IComponent, width, height int32, url string) *tVFCefTrayForm {
//	var trayForm *tVFCefTrayForm
...
//}
//
//func (m *tVFCefTrayForm) Tray() *Tray {
//	return nil
//}
//
//func (m *tVFCefTrayForm) Show() {
//	if BrowserWindow.mainBrowserWindow.Chromium() == nil || !BrowserWindow.mainBrowserWindow.Chromium().Initialized() {
//		return
//	}
//}
//
//func (m *tVFCefTrayForm) Hide() {
//}
//
//func (m *tVFCefTrayForm) close() {
//	if m.isClosing {
//		return
//	}
//	m.Hide()
//}
//
//func (m *tVFCefTrayForm) SetOnDblClick(fn lcl.TNotifyEvent) {
//	m.trayIcon.SetOnDblClick(fn)
//}
//
//func (m *tVFCefTrayForm) SetOnClick(fn lcl.TNotifyEvent) {
//	m.trayIcon.SetOnClick(fn)
//}
//
//func (m *tVFCefTrayForm) SetOnMouseUp(fn TMouseEvent) {
//	m.mouseUp = fn
//}
//func (m *tVFCefTrayForm) SetOnMouseDown(fn lcl.TMouseEvent) {
//	m.trayIcon.SetOnMouseDown(fn)
//}
//func (m *tVFCefTrayForm) SetOnMouseMove(fn lcl.TMouseMoveEvent) {
//	m.trayIcon.SetOnMouseMove(fn)
//}
//
//func (m *tVFCefTrayForm) Visible() bool {
//	return false
//}
//
//func (m *tVFCefTrayForm) SetVisible(v bool) {
//	m.trayIcon.SetVisible(v)
//}
//
//func (m *tVFCefTrayForm) SetHint(value string) {
//	m.trayIcon.SetHint(value)
//}
//
//func (m *tVFCefTrayForm) SetTitle(title string) {
//}
//
//func (m *tVFCefTrayForm) onmMouse() {
...
////content 气泡内容
////timeout 显示时间(毫秒)
//func (m *tVFCefTrayForm) SetBalloon(title, content string, timeout int32) ITray {
...
//
////显示托盘气泡
//func (m *tVFCefTrayForm) ShowBalloon() {
//	m.trayIcon.ShowBalloonHint()
//}
//
//func (m *tVFCefTrayForm) createCefTrayWindow() {
...
//
////设置托盘图标
//func (m *tVFCefTrayForm) SetIcon(iconResourcePath string) {

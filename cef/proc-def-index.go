...
const (
	...
	internale_CEF_Win_EndPaint
	internale_CEF_Win_BeginPaint
	internale_CEF_Win_Arc
	internale_CEF_Win_AngleChord
	internale_CEF_Win_CallNextHookEx
	internale_CEF_Win_CallWindowProc
	internale_CEF_Win_BitBlt
	internale_CEF_Win_CreateBitmap
	internale_CEF_Win_CreateBrushIndirect
	internale_CEF_Win_CreateBrushWithRadialGradient
	internale_CEF_Win_CreateCaret
	internale_CEF_Win_CreateCompatibleBitmap
	internale_CEF_Win_CreateCompatibleDC
	internale_CEF_Win_CreateDIBitmap
	internale_CEF_Win_CreateDIBSection
	internale_CEF_Win_CreateEllipticRgn
	internale_CEF_Win_CreateFontIndirect
	internale_CEF_Win_CreateFontIndirectEx
	internale_CEF_Win_CreateIconIndirect
	internale_CEF_Win_CreatePalette
	internale_CEF_Win_CreatePatternBrush
	internale_CEF_Win_CreatePenIndirect
	internale_CEF_Win_CreatePolygonRgn
	internale_CEF_Win_DeleteCriticalSection
	internale_CEF_Win_DeleteDC
	internale_CEF_Win_DestroyCaret
	internale_CEF_Win_DestroyCursor
	internale_CEF_Win_DestroyIcon
	internale_CEF_Win_DrawFrameControl
	internale_CEF_Win_DrawFocusRect
	internale_CEF_Win_DrawEdge
	internale_CEF_Win_DrawText
	internale_CEF_Win_EnableScrollBar
	internale_CEF_Win_EnableWindow
	internale_CEF_Win_EnterCriticalSection
	...
	internale_CEF_Win_ExtCreatePen
	internale_CEF_Win_ExtTextOut
	internale_CEF_Win_ExtSelectClipRGN
	internale_CEF_Win_FillRect
	internale_CEF_Win_FillRgn
	internale_CEF_Win_FloodFill
	internale_CEF_Win_FrameRect
	internale_CEF_Win_GetActiveWindow
	internale_CEF_Win_GetBitmapBits
	internale_CEF_Win_GetBkColor
	internale_CEF_Win_GetCapture
	internale_CEF_Win_GetCaretPos
	internale_CEF_Win_GetClientRect
	internale_CEF_Win_GetClipBox
	internale_CEF_Win_GetClipRGN
	internale_CEF_Win_GetCurrentObject
	internale_CEF_Win_GetCursorPos
	internale_CEF_Win_GetDC
	internale_CEF_Win_GetDeviceCaps
	internale_CEF_Win_GetDIBits
	internale_CEF_Win_GetDoubleClickTime
	internale_CEF_Win_GetFocus
	internale_CEF_Win_GetFontLanguageInfo
	internale_CEF_Win_GetForegroundWindow
	internale_CEF_Win_GetIconInfo
	internale_CEF_Win_GetKeyState
	internale_CEF_Win_GetMapMode
	internale_CEF_Win_GetMonitorInfo
	internale_CEF_Win_GetDpiForMonitor
	internale_CEF_Win_GetObject
	internale_CEF_Win_GetParent
	internale_CEF_Win_GetProp
	internale_CEF_Win_GetRgnBox
	internale_CEF_Win_GetROP2
	internale_CEF_Win_GetScrollInfo
	internale_CEF_Win_GetStockObject
	internale_CEF_Win_GetSysColor
	internale_CEF_Win_GetSysColorBrush
	internale_CEF_Win_GetSystemMetrics
	internale_CEF_Win_GetTextColor
	internale_CEF_Win_GetTextExtentExPoint
	internale_CEF_Win_GetTextExtentPoint
	internale_CEF_Win_GetTextExtentPoint32
	internale_CEF_Win_GetTextMetrics
	internale_CEF_Win_GetViewPortExtEx
	internale_CEF_Win_GetViewPortOrgEx
	internale_CEF_Win_GetWindowExtEx
	internale_CEF_Win_GetWindowLong
	internale_CEF_Win_GetWindowRect
	internale_CEF_Win_GetWindowSize
	internale_CEF_Win_GetWindowOrgEx
	internale_CEF_Win_GradientFill
	internale_CEF_Win_HideCaret
	internale_CEF_Win_InitializeCriticalSection
	internale_CEF_Win_IntersectClipRect
	internale_CEF_Win_InvalidateRect
	internale_CEF_Win_InvalidateRgn
	internale_CEF_Win_IsDBCSLeadByte
	internale_CEF_Win_IsIconic
	internale_CEF_Win_IsWindow
	internale_CEF_Win_IsWindowEnabled
	internale_CEF_Win_IsWindowVisible
	internale_CEF_Win_IsZoomed
	internale_CEF_Win_LeaveCriticalSection
	internale_CEF_Win_LineTo
	internale_CEF_Win_LoadBitmap
	internale_CEF_Win_LoadIcon
	internale_CEF_Win_MaskBltRop
	internale_CEF_Win_MaskBlt
	internale_CEF_Win_MessageBox
	internale_CEF_Win_MonitorFromPoint
	internale_CEF_Win_MonitorFromRect
	internale_CEF_Win_MonitorFromWindow
	internale_CEF_Win_MoveToEx
	internale_CEF_Win_OffsetRgn
	internale_CEF_Win_PaintRgn
	internale_CEF_Win_Pie
	internale_CEF_Win_PolyBezier
	internale_CEF_Win_Polygon
	internale_CEF_Win_Polyline
	internale_CEF_Win_PostMessage
	internale_CEF_Win_RealizePalette
	internale_CEF_Win_Rectangle
	internale_CEF_Win_RectInRegion
	internale_CEF_Win_RectVisible
	internale_CEF_Win_RedrawWindow
	internale_CEF_Win_ReleaseCapture
	internale_CEF_Win_ReleaseDC
	internale_CEF_Win_RemoveProp
	internale_CEF_Win_RestoreDC
	internale_CEF_Win_RoundRect
	internale_CEF_Win_SaveDC
	internale_CEF_Win_ScrollWindowEx
	internale_CEF_Win_SelectClipRGN
	internale_CEF_Win_SelectObject
	internale_CEF_Win_SelectPalette
	internale_CEF_Win_SendMessage
	internale_CEF_Win_SetActiveWindow
	internale_CEF_Win_SetBkColor
	internale_CEF_Win_SetBkMode
	internale_CEF_Win_SetCapture
	internale_CEF_Win_SetCaretPos
	internale_CEF_Win_SetCaretPosEx
	internale_CEF_Win_SetCursorPos
	internale_CEF_Win_SetFocus
	internale_CEF_Win_SetForegroundWindow
	internale_CEF_Win_SetMapMode
	internale_CEF_Win_SetMenu
	internale_CEF_Win_SetParent
	internale_CEF_Win_SetProp
	internale_CEF_Win_SetROP2
	internale_CEF_Win_SetScrollInfo
	internale_CEF_Win_SetStretchBltMode
	internale_CEF_Win_SetTextCharacterExtra
	internale_CEF_Win_SetTextColor
	internale_CEF_Win_SetWindowLong
	internale_CEF_Win_SetViewPortExtEx
	internale_CEF_Win_SetViewPortOrgEx
	internale_CEF_Win_SetWindowExtEx
	internale_CEF_Win_SetWindowOrgEx
	internale_CEF_Win_SetWindowPos
	internale_CEF_Win_ShowCaret
	internale_CEF_Win_ShowScrollBar
	internale_CEF_Win_ShowWindow
	internale_CEF_Win_StretchBlt
	internale_CEF_Win_StretchDIBits
	internale_CEF_Win_SystemParametersInfo
	internale_CEF_Win_TextOut
	internale_CEF_Win_UpdateWindow
	internale_CEF_Win_WindowFromPoint
	// TCefBaseRefCounted
	...
	internale_CEFChromium_SimulateMouseWheel
	internale_CEFChromium_CloseAllConnections
	internale_CEFChromium_RetrieveHTMLByFrameName
	internale_CEFChromium_RetrieveHTMLByFrame
	internale_CEFChromium_RetrieveHTMLByFrameIdentifier
	internale_CEFChromium_RetrieveTextByFrameName
	internale_CEFChromium_RetrieveTextByFrame
	internale_CEFChromium_RetrieveTextByFrameIdentifier
	internale_CEFChromium_ResolveHost
	internale_CEFChromium_SetUserAgentOverride
	internale_CEFChromium_ClearDataForOrigin
	internale_CEFChromium_ClearCache
	internale_CEFChromium_ToggleAudioMuted
	internale_CEFChromium_ClipboardCopy
	internale_CEFChromium_ClipboardPaste
	internale_CEFChromium_ClipboardCut
	internale_CEFChromium_ClipboardUndo
	internale_CEFChromium_ClipboardRedo
	internale_CEFChromium_ClipboardDel
	internale_CEFChromium_SelectAll
	internale_CEFChromium_IncZoomStep
	internale_CEFChromium_DecZoomStep
	internale_CEFChromium_IncZoomPct
	internale_CEFChromium_DecZoomPct
	internale_CEFChromium_ResetZoomStep
	internale_CEFChromium_ResetZoomPct
	internale_CEFChromium_ReadZoom
	internale_CEFChromium_WasResized
	internale_CEFChromium_WasHidden
	internale_CEFChromium_NotifyScreenInfoChanged
	internale_CEFChromium_IMESetComposition
	internale_CEFChromium_IMECommitText
	internale_CEFChromium_IMEFinishComposingText
	internale_CEFChromium_IMECancelComposition
	// ICefFrame

...
func (m *BrowserWindow) FormCreate(sender lcl.IObject) {
	...
	//m.windowParent.SetBounds(100, 100, 200, 200)
	...
	//if Windows.GetClientRect(self.Handle, ARect) then
	//Windows.SetWindowPos(self.Handle, 0, 0, 0, ARect.Right - ARect.Left, ARect.Bottom - ARect.Top, SWP_NOMOVE or SWP_NOZORDER or SWP_NOACTIVATE)
}

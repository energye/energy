...
// TODO: GtkTextIter size on 32-bit needs verification.
// On 64-bit it is 80 bytes. On 32-bit it should be smaller due to pointer size difference.
// This value needs to be confirmed by compiling a C sizeof check on a 32-bit system.
const textIterSize = 52

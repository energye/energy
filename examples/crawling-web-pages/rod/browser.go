...
import (
	...
	"github.com/energye/energy/v2/examples/crawling-web-pages/rod/pkgs/devices"
	"github.com/energye/energy/v2/examples/crawling-web-pages/rod/pkgs/goob"
...
// https://pkg.go.dev/github.com/energye/energy/v2/examples/crawling-web-pages/rod/pkgs/defaults
type Browser struct {

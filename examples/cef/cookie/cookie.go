...
func main() {
	...
	ipc.On("SetCookie", func(context context.IContext) {
		info := cef.BrowserWindow.GetWindowInfo(context.BrowserId())
		info.Chromium().SetCookie("https://www.example.com", "example_cookie_name", "1234", "", "/", true, true, false, time.Now(), time.Now(), time.Now(), types.Ccss_CEF_COOKIE_SAME_SITE_UNSPECIFIED, types.CEF_COOKIE_PRIORITY_MEDIUM, false, 0)
		info.Chromium().SetCookie("https://www.example.com", "example_cookie_name2", "123422", "", "/", true, true, false, time.Now(), time.Now(), time.Now(), types.Ccss_CEF_COOKIE_SAME_SITE_UNSPECIFIED, types.CEF_COOKIE_PRIORITY_MEDIUM, false, 0)
		info.Chromium().SetCookie("https://www.baidu.com", "demo_name", "4321", "", "/", true, true, false, time.Now(), time.Now(), time.Now(), types.Ccss_CEF_COOKIE_SAME_SITE_NO_RESTRICTION, types.CEF_COOKIE_PRIORITY_MEDIUM, false, 1)

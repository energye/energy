...
// 控制组件UI
// 地址栏和控制按钮创建
func controlUI(browserWindow *cef.LCLBrowserWindow) (goBack lcl.IButton, goForward lcl.IButton, stop lcl.IButton, refresh lcl.IButton, progressLabel lcl.ILabel, addrBox lcl.IComboBox) {
